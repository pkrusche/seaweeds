...
/* this is implemented in seaweeds_*.asm -- reference implementation in 
 * xasmlib.c
 */
extern void __cdecl cmpxchg_with_mask_8(UINT64 * data, UINT64 * data2, UINT64 * mask, size_t len);
